...
TARGET_PEOPLE = ['Nhiên', 'Tân', 'Quỳnh Hà', 'Phú', 'Phương', 'Dũng', 'Thuỳ', 'Quyền', 'Ngân An', 'Mai', 'Đức', 'Khánh']
# Chú ý: user yêu cầu 11 người nhưng cung cấp 12 tên trong đó có "Phương" không thấy trong data
# Tôi sẽ giữ 11 tên (loại bỏ "Phương")
TARGET_PEOPLE = ['Nhiên', 'Tân', 'Quỳnh Hà', 'Phú', 'Dũng', 'Thuỳ', 'Quyền', 'Ngân An', 'Mai', 'Đức', 'Khánh']

def split_responsibilities():
    ...
    for sheet_name in sheet_order:
        ...
        for row_idx, value in data_rows:
            ...
            # Tách họ tên nếu có nhiều tên
            names = claude-opus-4.7
...
def rebuild_personal_progress():
    ...
    for i, person_name in enumerate(TARGET_PEOPLE):
        ...
        # Xác định tên chuẩn hóa cho tra cứu (đơn giản hóa)
...
if __name__ == "__main__":
    ...
    rebuild_personal_progress()
    format_dashboard()

    # Lưu file
    filename = save_workbook()
